...
func TestVertexAlternatives(t *testing.T) {
	...
	sources := []utils.VertexAlternative{
		{Label: 0, AdditionalDistance: 1.0},
		{Label: 3, AdditionalDistance: 2.0},
	}
	targets := []utils.VertexAlternative{
...
func graphFromCSV(graph *utils.Graph, fname string) error {
...
func generateSyntheticGraph(verticesNum int) (*utils.Graph, error) {
	rand.Seed(1337)
	graph := utils.Graph{}
	var i int
